...
x = 1  #integer
x = 1.1 #float number with decimal
print(10 + 3)
print(10 - 3)
print(10 * 3)
print(10 / 3)
...
z = 30
z*= 3 #augmented operator multipley
print(z)
...
#Chapter  2.9 Type Comparision
x = input("Enter  a value for x: ")
y = int(x) + 1
print(f"x: {x}, y: {y}")
print("." * 10)

rate = input("Enter interest rate,eg 0.5: ")
rate = float(rate) #may reuse the same ariable
# CRITICAL KNOWLEDGE
# three different ways to output a number variable with text
print(f"Borrower does not qualify at (rate)") #string interpolation
print("Borrower does no qualify at", rate)
print("Borrow does not qualify at " + str(rate)) #convert to string
print()
# DR. Humpherys likes interpolation the best!

#Diplaying decimals in strings
grams = 15.125
